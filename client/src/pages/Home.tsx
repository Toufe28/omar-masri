...
const locations = [
  ["01", { ar: "الفيوم", en: "London" }, { ar: "مكتب ميداني · GMT", en: "Field office · GMT" }],
  ["02", { ar: "المعادي", en: "New York" }, { ar: "شريك إنتاج · EST", en: "Production partner · EST" }],
  ["03", { ar: "نهر النيل", en: "Paris" }, { ar: "شبكة كاستينج · CET", en: "Casting network · CET" }],
  ["04", { ar: "الجيزة", en: "Everywhere else" }, { ar: "على مقاس النور الصح", en: "Built around the right light" }],
] as const;
